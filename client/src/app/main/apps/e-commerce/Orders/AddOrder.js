                    ...
                    <div className="flex flex-col p-12 flex-1 h-auto">
                      <div className="flex flex-col">
                        {(eyeglasses || contactLenses || medication) && (
                          <div className="flex flex-col border-1 border-black border-solid">
                            {eyeglasses.map((row, index) => (
                              <div
                                className="px-20 py-10 border-b-1 border-black border-solid"
                                key={index}>
                                <div className="flex flex-row justify-between">
                                  <h3>Frame Price: {row.frameBrand}</h3>
                                  <h3>
                                    $
                                    {row?.frameRate &&
                                      Number(row?.frameRate).toLocaleString()}
                                ...
                                <div className="flex flex-row justify-between">
                                  <h3>Lens Price: {row?.lensDetail}</h3>
                                  <h3>
                                    $
                                    {row?.lensRate &&
                                      Number(row?.lensRate).toLocaleString()}
                            ...
                            {contactLenses.map((row, index) => (
                              <div
                                ...
                                key={index}>
                                <div className="flex flex-row justify-between">
                                  <h3>Contact Lens Price: {row.type}</h3>
                                  <h3>
                                    $
                                    {row?.contactLensRate &&
                                      Number(
                            ...
                            {medication.map((row, index) => (
                              <div
                                className="px-20 py-10 border-black border-solid"
                                key={index}>
                                <div className="flex flex-row justify-between">
                                  <h3> {row?.name}</h3>
                                  <h3>

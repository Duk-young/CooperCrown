                  ...
                  <div>
                    ...
                    <div className="flex flex-row w-full border-collapse">
                      ...
                      <div className="w-1/6 border-box">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(eyeglasses[0]?.eyeglassesSphereOd)}</p>
                      </div>
                      <div className="w-1/6 border-box">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(eyeglasses[0]?.eyeglassesCylinderOd)}</p>
                      </div>
                      <div className="w-1/6 border-box">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(eyeglasses[0]?.eyeglassesAxisOd)}</p>
                      </div>
                      <div className="w-1/6 border-box">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(eyeglasses[0]?.eyeglassesAddOd)}</p>
                      </div>
                      <div className="w-2/6 border-box border-r-1">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(eyeglasses[0]?.eyeglassesPrismOd)}</p>
                      </div>
                    </div>
                    <div className="flex flex-row w-full border-collapse">
                      ...
                      <div className="w-1/6 border-box border-b-1">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(eyeglasses[0]?.eyeglassesSphereOs)}</p>
                      </div>
                      <div className="w-1/6 border-box border-b-1">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(eyeglasses[0]?.eyeglassesCylinderOs)}</p>
                      </div>
                      <div className="w-1/6 border-box border-b-1">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(eyeglasses[0]?.eyeglassesAxisOs)}</p>
                      </div>
                      <div className="w-1/6 border-box border-b-1">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(eyeglasses[0]?.eyeglassesAddOs)}</p>
                      </div>
                      <div className="w-2/6 border-box border-r-1 border-b-1">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(eyeglasses[0]?.eyeglassesPrismOs)}</p>
                      </div>
                    </div>
                    {eyeglasses[0]?.eyeglassesmemo && <p className='py-6 font-7pt'>{`Memo: ${eyeglasses[0]?.eyeglassesmemo}`}</p>}
                    ...
                    <div className="flex flex-row w-full border-collapse px-32">
                      ...
                      <div className="w-1/4 border-box">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(eyeglasses[0]?.pdOuDistance)}</p>
                      </div>
                      <div className="w-1/4 border-box">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(eyeglasses[0]?.pdOdDistance)}</p>
                      </div>
                      <div className="w-1/4 border-box border-r-1">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(eyeglasses[0]?.pdOsDistance)}</p>
                      </div>
                    </div>
                    <div className="flex flex-row w-full border-collapse px-32 pb-6">
                      ...
                      <div className="w-1/4 border-box border-b-1">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(eyeglasses[0]?.pdOuNear)}</p>
                      </div>
                      <div className="w-1/4 border-box border-b-1">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(eyeglasses[0]?.pdOdNear)}</p>
                      </div>
                      <div className="w-1/4 border-box border-r-1 border-b-1">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(eyeglasses[0]?.pdOsNear)}</p>
                      </div>
                    </div>
                    <div className='w-full h-2 bg-black my-4'></div>
                  </div>
                ...
                {contactLenses?.length > 0 && (
                  <div>
                    ...
                    <div className="flex flex-row w-full border-collapse">
                      ...
                      <div className="w-1/4 border-box">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(contactLenses[0]?.contactLensSphereOd)}</p>
                      </div>
                      <div className="w-1/4 border-box">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(contactLenses[0]?.contactLensCylinderOd)}</p>
                      </div>
                      <div className="w-1/4 border-box">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(contactLenses[0]?.contactLensAxisOd)}</p>
                      </div>
                      <div className="w-1/4 border-box border-r-1">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(contactLenses[0]?.contactLensAddOd)}</p>
                      </div>
                    </div>
                    <div className="flex flex-row w-full border-collapse">
                      <div className="w-20 border-box border-b-1">
                      ...
                      <div className="w-1/4 border-box border-b-1">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(contactLenses[0]?.contactLensSphereOs)}</p>
                      </div>
                      <div className="w-1/4 border-box border-b-1">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(contactLenses[0]?.contactLensCylinderOs)}</p>
                      </div>
                      <div className="w-1/4 border-box border-b-1">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(contactLenses[0]?.contactLensAxisOs)}</p>
                      </div>
                      <div className="w-1/4 border-box border-b-1 border-r-1">
                        <p className='font-7pt text-center'>{addTwoDecimalPlaces(contactLenses[0]?.contactLensAddOs)}</p>
                      </div>
                    </div>
                    {contactLenses[0]?.contactLensMemo && <p className='py-6 font-7pt'>{`Memo: ${contactLenses[0]?.contactLensMemo}`}</p>}
                    <div className='w-full h-2 bg-black my-4'></div>
                  </div>
                )}

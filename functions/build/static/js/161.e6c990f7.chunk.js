        ...
        m = Object(p.a)(function (e) {
          return {
            ...
            badge: {
              ...
              padding: "5px 8px",
              borderRadius: 2,
              "&.new": { backgroundColor: l.a[500] },
              "&.fix": { backgroundColor: c.a[500] },
              "&.breaking": { backgroundColor: u.a[500] },
            },
          };
        });
      function h(e) {
        ...
        return s.a.createElement(
          i.a,
          { className: Object(g.a)(a.root, e.className) },
          s.a.createElement(
            "div",
            ...
            e.version &&
              s.a.createElement(
                d.a,
                { className: "text-24", component: "h2" },
                "v".concat(e.version)
              ),
            e.date &&
              s.a.createElement(
          ...
          e.newChanges.length > 0 &&
            s.a.createElement(
              "div",
              { className: "mt-24" },
              s.a.createElement(
                "div",
                { className: Object(g.a)(a.badge, "new") },
                "New"
              ),
              s.a.createElement(
                "ul",
                { className: "my-16 px-24" },
                e.newChanges.map(function (e, a) {
                  return s.a.createElement(
                    "li",
                    { key: a, className: "mb-6" },
                    s.a.createElement(d.a, null, e)
                  );
                })
              )
            ),
          e.fixedChanges.length > 0 &&
            s.a.createElement(
              "div",
              { className: "mt-24" },
              s.a.createElement(
                "div",
                { className: Object(g.a)(a.badge, "fix") },
                "Fixed"
              ),
              s.a.createElement(
                "ul",
                { className: "my-16 px-24" },
                e.fixedChanges.map(function (e, a) {
                  return s.a.createElement(
                    "li",
                    { key: a, className: "mb-6" },
                    s.a.createElement(d.a, null, e)
          ...
          e.breakingChanges.length > 0 &&
            s.a.createElement(
              ...
              s.a.createElement(
                "div",
                { className: Object(g.a)(a.badge, "breaking") },
                "Breaking Changes"
              ),
              s.a.createElement(
                "ul",
                { className: "my-16 px-24" },
                e.breakingChanges.map(function (e, a) {
                  return s.a.createElement(
                    "li",
                    { key: a, className: "mb-6" },
                    s.a.createElement(d.a, null, e)
        ...
        v = [
            ...
            newChanges: [
              ...
              s.a.createElement(
                ...
                s.a.createElement(
                  "code",
                  null,
                  'name="profile.username" value={form.profile.username}'
                ),
                ")"
              ),
            ],
          ...
          },
          {
            ...
            fixedChanges: [
              s.a.createElement(
                ...
                s.a.createElement(
                  "i",
                  null,
                  '"createBrowserHistroy is not exported from history.js"'
                ),
                " error on windows environment(rare)"
              ),
            ],
            breakingChanges: [
              s.a.createElement(
            ...
            notes: s.a.createElement(
              ...
              {
                className:
                  "text-14 p-12 border-2 rounded-8 w-full max-w-lg mt-16",
                component: "div",
              },
              "Migrating to the new major version (",
              s.a.createElement("b", null, "v3.0.0"),
              ") can be difficult because of the hooks support and major dependency releases."
            ),
          },
          {
            version: "2.2.5",
          ...
          },
          {
            ...
            newChanges: [
              ...
              s.a.createElement(
                "span",
                null,
                s.a.createElement("b", null, "firebaseService"),
                " and ",
                s.a.createElement("b", null, "auth0Service"),
                " created, ",
                s.a.createElement("b", null, "Auth"),
          ...
          },
          {
            ...
            newChanges: [
              s.a.createElement(
                "span",
                null,
                s.a.createElement("code", null, "velocity-react"),
                " added as dependency, its used for fuseAnimation"
              ),
              s.a.createElement(
                "span",
                null,
                s.a.createElement("code", null, "FuseAnimation"),
                " ",
                s.a.createElement("code", null, "FuseAnimationGroup"),
                " created for easily animate components and applied most of the pages."
              ),
              s.a.createElement(
                "span",
                null,
                s.a.createElement("code", null, "exact"),
                " property option added to navigation item for matching location exactly."
              ),
              "Dependency packages updated.",
            ],
          },
          {
            ...
            newChanges: [
              ...
              s.a.createElement(
                "span",
                null,
                s.a.createElement("code", null, "react-poper"),
                " added as dependency, its used for horizontal navigation"
              ),
              s.a.createElement(
                "span",
                null,
                s.a.createElement("code", null, "Material UI"),
                " updated to v1.2.0"
              ),
              "Dependency packages updated.",
            ],
          ...
          },
          {
            ...
            breakingChanges: [
              s.a.createElement(
                "span",
                null,
                s.a.createElement("code", null, "FuseAuth"),
                " renamed with FuseAuthorization"
              ),
          ...
          },
          {
            ...
            newChanges: [
              ...
              s.a.createElement(
                "span",
                null,
                s.a.createElement("code", null, "google-map-react"),
                " updated."
              ),
            ],
          },
          {
            ...
            fixedChanges: [
              ...
              s.a.createElement(
                ...
                null,
                "missing ",
                s.a.createElement("code", null, ".env"),
                " ",
                s.a.createElement("code", null, ".babelrc"),
                " files added."
              ),
            ],
          },
          {
            ...
            fixedChanges: [
              s.a.createElement(
                "span",
                null,
                s.a.createElement("code", null, "cross-env"),
          ...
          },
          {
            ...
            notes: s.a.createElement(
              "ul",
              { className: "mt-24 pl-24" },
              s.a.createElement(
                "li",
                null,
                s.a.createElement(d.a, null, "Initial Release")
              )
            ),
          },
        ];
          ...
          header: s.a.createElement(
            ...
            s.a.createElement(
              ...
              s.a.createElement(
                ...
                s.a.createElement(
                  o.a,
                  { className: "text-18", color: "action" },
                  "home"
                ),
                s.a.createElement(
                  o.a,
                  { className: "text-16", color: "action" },
                  "chevron_right"
                ),
                s.a.createElement(
                  d.a,
              ...
              s.a.createElement(d.a, { variant: "h6" }, "Changelog")
            )
          ),
          content: s.a.createElement(
            "div",
            { className: "p-24 max-w-xl" },
            v.map(function (e) {
              return s.a.createElement(
                f,
                Object.assign({ className: "mb-24", key: e.version }, e)
              );
            })
          ),
        });
